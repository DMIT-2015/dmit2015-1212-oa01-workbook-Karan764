 ...
 *    2) Add a key/value pair in the following format: *          package-name.ClassName/mp-rest/url=baseUri
 *       For example:
 ...
 * *     @Inject
 *     @RestClient
 *     private MovieMicroprofileService _movieService;
...
public interface WeatherService {
    ...
    @GET
    OpenWeatherData findByCityName(@QueryParam(("q")) String cityName,
                                   @QueryParam("appid") String apiKey,
                                   @QueryParam("units") String units);

    OpenWeatherData findByGpsLocation(@QueryParam("lat") Double latitude,
