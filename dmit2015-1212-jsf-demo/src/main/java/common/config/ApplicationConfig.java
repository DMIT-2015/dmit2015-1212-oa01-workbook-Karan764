...
@DataSourceDefinitions({
	...
	@DataSourceDefinition(
		...
		className="com.microsoft.sqlserver.jdbc.SQLServerDataSource",
			url="jdbc:sqlserver://DMIT-Capstone1.ad.sast.ca;databaseName=DMIT2015_1212_A01_kbhagwani1;TrustServerCertificate=true",   // change A01 to E01 if you are in section E01, change yourNaitUsername
			user="kbhagwani1",  //  change yourNaitUsername
			password="RemotePassword200460740"),    // Replace 200012345 with your NAIT StudentID
